...
import DatePicker from "../mayLike/DatePicker";
import { useTranslation } from "react-i18next";
import AlertDialog from "../mayLike/AlertDialog";
    ...
    <div>
      <Button
        sx={{
          ...
          fontSize: "1vw",
          boxShadow:
            "0px 6px 15px 6px rgba(253, 89, 86, 0.08), 0px 15px 15px 6px rgba(253, 89, 86, 0.08)",
          borderRadius: "50px",
          "&:hover": {
            backgroundColor: "#E87B5A",
          },
        ...
        className="HeroProducsActionsChipMobile"
      >
